...
/**
 * OpenAPI / Swagger UI configuration for the FPE service.
 *
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("FPE Service API")
                        .description("Fare Pricing Engine — computes upfront fares, surge multipliers, "
                                + "and discount applications for the VNPT AV Platform.")
                        .version("1.0.0")
                        .contact(new Contact()
