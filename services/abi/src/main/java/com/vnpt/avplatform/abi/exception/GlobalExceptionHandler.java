package com.vnpt.avplatform.abi.exception;
...
/**
 * Global exception handler for the ABI service.
 *
...
public class GlobalExceptionHandler {
     ...
     * Returns a 400 with a concatenated list of all field errors.
     */
    ...
    /**
     * Handles missing required request headers (e.g., {@code X-Tenant-ID}).
     */
    ...
    public ResponseEntity<ApiResponse<Void>> handleAccessDeniedException(
        ...
        return ResponseEntity
            ...
            .body(ApiResponse.error("FORBIDDEN", "Access denied", HttpStatus.FORBIDDEN.value(), traceId));
    }
