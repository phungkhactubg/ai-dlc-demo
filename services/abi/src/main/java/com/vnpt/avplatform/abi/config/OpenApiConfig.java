...
/**
 * OpenAPI 3.0 documentation configuration for the ABI service.
 *
...
public class OpenApiConfig {
    ...
    /**
     * Configures the OpenAPI bean with service metadata, Bearer auth scheme,
     * and global security requirement.
     *
     * @return the configured {@link OpenAPI} instance
     */
    @Bean
    public OpenAPI abiOpenApi() {
        return new OpenAPI()
            .info(new Info()
                .title("ABI Service API")
                .description("Analytics & Business Intelligence Service — VNPT AV Platform")
                .version("1.0.0")
                .contact(new Contact()
            ...
            .components(new Components()
                .addSecuritySchemes(SECURITY_SCHEME_NAME,
                    new SecurityScheme()
                        ...
                        .scheme("bearer")
                        .bearerFormat("JWT")
                        .description("JWT Bearer token. Obtain from the authentication service.")));
    }
