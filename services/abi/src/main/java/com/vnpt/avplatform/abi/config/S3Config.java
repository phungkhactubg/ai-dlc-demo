...
/**
 * AWS S3 / MinIO-compatible client configuration for the ABI service.
 *
 * <p>ABI uses the S3 client to export generated analytics reports to the MinIO
 * object store. Reports are uploaded as JSON or CSV files and made available
 * for downstream consumers (dashboards, data warehouses).</p>
 *
 ...
 *   <li>{@code minio.bucket} — target bucket for reports</li>
 * </ul>
 */
@Configuration
