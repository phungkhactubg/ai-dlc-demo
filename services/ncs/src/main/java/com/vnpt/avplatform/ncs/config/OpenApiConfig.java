...
/**
 * OpenAPI / Swagger configuration for the NCS service.
 *
 * <p>Adds:</p>
 * <ul>
...
public class OpenApiConfig {
     ...
     */
    @Bean
    public OpenAPI ncsOpenApi() {
        return new OpenAPI()
                .info(new Info()
                        .title("NCS Service API")
                        .description("Notification & Communication Service — VNPT AV Platform")
                        .version("1.0.0")
                        .contact(new Contact()
